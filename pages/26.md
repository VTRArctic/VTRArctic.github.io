...
Now imagine Anista created a new "nose" item slot, and gave every player a +2 `CON` nose item. Can you think of any scenario in which it would be beneficial to be Player 1?

In short, try to aim for 25-26 when allocating stat points. Utility is often lost when going over this amount.
